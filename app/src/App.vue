<template>
  <div id="app" :class="system.default_currency">
    ...
    <template v-if="isLoading">
      <div class="flex flex-direction align-center justify-center vw-100 vh-100 bg-primary">
    ...
    async getToken() {
      this.$http.get('v1/init', {
        ...
        .then(res=>{
          ...
          this.$store.commit('setState', {key:'free_task_num', value: res.data.free_task_num})
...
.₫ {
  .money-number::before,.money-number-small::before {
