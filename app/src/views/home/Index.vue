<template>
  <div class="index-page flex flex-direction">
    ...
    <div class="primary-wrap flex flex-direction padding">
      <div class="flex align-center margin-bottom justify-between" style="z-index:2">
        <balance-banner/>
      ...
      <base-swipe-ad-banner class="margin-bottom border-radius overflow-hidden" style="z-index:1"/>

      <base-notice-bar theme="dark" style="z-index:1"/>
    </div>

    <div class="flex align-center margin-lr margin-bottom-sm">
      <img src="../../assets/images/ad_logo.png" class="margin-right-xs" style="height:0.58rem">
...
export default {
  ...
  computed: {
    ...mapState(['hotTasks','userVipInfo','userVipFinishedCount','aboutContent','banners']),
    languageName() {
    ...
    getData() {
      if (!this.banners.length) {
        ...
        this.$http
            .get("v1/home")
            .then((res) => {
              this.$store.commit('setState',{key:'banners', value:res.data.banners})
