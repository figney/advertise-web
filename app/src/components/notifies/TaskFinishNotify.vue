<template>
  <div class="task-finish-notify flex flex-direction align-center padding padding-top-xs">
    <img src="../../assets/images/icon_27@2x.png" class="margin-bottom-xs" style="height:2.18rem">
    <div class="font-bold fs-18 margin-bottom-sm text-center">{{$t('AD_TASK_AWARD_ARRIVED','恭喜您获得广告任务奖励')}}</div>
